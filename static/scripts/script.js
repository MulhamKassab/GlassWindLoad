...
function gatherDataFromInput() {
    ...
    for(let i = 0; i < numberOfLayers; i++) {
        ...
        if(layerType === 'mono') {
            ...
            const lami_1_2_sided_nominal = [5.56, 7.42, 9.02, 11.91, 15.09, 18.26, 19.20, 23.15];
            const lami_4_sided_nominal = [4.57,5.56, 7.42, 9.02, 11.91, 15.09, 18.26, 19.20, 23.15];

            const lami_1_2_sided = [6, 8, 10, 12, 16, 19, 20, 24];
